...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 May 2025 09:15:16 GMT -->
<head>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md" aria-labelledby="navbarDropdown">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action border-0" href="../../geeks-rtl/index.html" target="_blank">
                                    <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <form class="row gx-3 needs-validation" novalidate>
                                    ...
                                    <div class="mb-3 col-12 col-md-6">
                                        ...
                                        <input type="text" id="profileEditFname" name="firstname" class="form-control" placeholder="First Name" required />
                                        <div class="invalid-feedback">Please enter first name.</div>
                                    </div>
                                    <!-- Last name -->
                                    <div class="mb-3 col-12 col-md-6">
                                        <label class="form-label" for="profileEditLname">Last Name</label>
                                        <input type="text" id="profileEditLname" name="lastname" class="form-control" placeholder="Last Name" required />
                                        <div class="invalid-feedback">Please enter last name.</div>
                                    </div>
                                    <!-- Phone -->
                                    <div class="mb-3 col-12 col-md-6">
                                        <label class="form-label" for="profileEditPhone">Matric Number</label>
                                        <input type="text" id="profileEditPhone" name="matricnumber" class="form-control" placeholder="Phone" required />
                                        <div class="invalid-feedback">Please enter phone number.</div>
                                    </div>
                                    <!-- Birthday -->
                                    <div class="mb-3 col-12 col-md-6">
                                        <label class="form-label" for="profileEditBirth">Course</label>
                                        <input class="form-control flatpickr" type="text" placeholder="Birth of Date" id="profileEditBirth" name="coursename" />
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/dashboard-student.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 05 May 2025 09:15:18 GMT -->
</html>
