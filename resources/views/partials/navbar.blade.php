    ...
    <div class="container px-0">
        ...
        <div class="ms-auto d-flex align-items-center order-lg-3">
            <div class="d-flex gap-2 align-items-center">
                ...
                @if($role === 'admin')
                <a href="{{ route('') }}" class="btn btn-outline-dark me-2">Dashboard</a>
                @elseif($role === 'student')
                <a href="{{ route('student.users.show', auth()->user()->id) }}" class="btn btn-outline-dark me-2">Dashboard</a>
                @elseif($role === 'instructor')
                <a href="{{ url('/instructor/dashboard') }}" class="btn btn-outline-dark me-2">Dashboard</a>
                @endif
